...
loader.load('threejs-3d-model-personalized/Ch14_nonPBR.fbx', (object) => {
    ...
    loader.load('threejs-3d-model-personalized/Gangnam Style.fbx', (animation) => {
...
// Ajustar la posición de la cámara y el punto de vista
camera.position.set(0, 10, 50); // Ajusta estos valores para mover la cámara más cerca y de frente
camera.lookAt(new THREE.Vector3(0, 10, 0)); // Asegúrate de que la cámara apunte hacia el modelo
